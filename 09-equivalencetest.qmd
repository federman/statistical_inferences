...
opts_p <- c(
   ...
   "We can not statistically reject (using an alpha of 0.05) effects anyone would find practically relevant.", 
...
opts_p <- c(
   ...
   "Observed effect sizes of *d* = 0.5 will be statistically significant 5% of the time.",
